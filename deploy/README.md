...
```bash
flyctl logs                    # expect: "scheduler up — 11 jobs, timezone America/New_York"
...
|---|---|---|
| Scheduler booted | `flyctl logs` / `docker compose logs agent` | `scheduler up — 11 jobs, timezone America/New_York` |
