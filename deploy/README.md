...
```bash
flyctl logs                    # expect: "scheduler up — 13 jobs, timezone America/New_York"
...
|---|---|---|
| Scheduler booted | `flyctl logs` / `docker compose logs agent` | `scheduler up — 13 jobs, timezone America/New_York` |
