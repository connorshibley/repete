...
and the live bot were found to differ — **20 as of 2026-08-10**, fourteen closed
...
**2,270 tests as of 2026-08-11**, offline by design — no credentials, ever, in CI.
...
.venv/bin/python -m pytest tests/ -q  # 2270, offline, no keys needed
