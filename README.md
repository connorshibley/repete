...
and the live bot were found to differ — **18 as of 2026-08-06**, thirteen closed
by a **named test** and five open by construction, because "fixed in code" has been
...
**2,022 tests as of 2026-08-06**, offline by design — no credentials, ever, in CI.
...
.venv/bin/python -m pytest tests/ -q  # 2022, offline, no keys needed
