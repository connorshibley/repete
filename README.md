...
and the live bot were found to differ — **25 as of 2026-08-28**, fifteen closed
by a **named test** and ten open, because "fixed in code" has been
...
**2,816 tests as of 2026-08-31**, offline by design — no credentials, ever, in CI.
...
.venv/bin/python -m pytest tests/ -q  # 2816, offline, no keys needed
