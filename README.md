...
and the live bot were found to differ — **22 as of 2026-08-22**, fifteen closed
...
**2,655 tests as of 2026-08-23**, offline by design — no credentials, ever, in CI.
...
.venv/bin/python -m pytest tests/ -q  # 2655, offline, no keys needed
