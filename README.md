...
and the live bot were found to differ — **19 as of 2026-08-09**, thirteen closed
by a **named test** and six open, because "fixed in code" has been
...
**2,113 tests as of 2026-08-09**, offline by design — no credentials, ever, in CI.
...
.venv/bin/python -m pytest tests/ -q  # 2113, offline, no keys needed
